...
export var COMENTARIOS: ComentariosService[] = [
{"texto":"Recomiendo la película totalmente, soy más de películas del oeste pero esta me ha encantado.","usuario":this.perfil[0].id, "fecha":"22/2/2222"},
